     ...
     <Navbar />
      <div className="mt-[100px] px-[10px] sm:px-[120px]">
           ...
           <div className="my-[30px] flex flex-col gap-[20px] text-[16px]">
               <p>SALONSURF VENTURES PRIVATE LIMITED built the LUZO app as a Commercial app. This SERVICE is provided by SALONSURF VENTURES PRIVATE LIMITED and is intended for use as is.</p>
               ...
               <p>The terms used in this Privacy Policy have the same meanings as in our Terms of Service, which is accessible in LUZO unless otherwise defined in this Privacy Policy.</p>
               <p>Information Collection, Deletion and Use</p>
               <p>For a better experience, while using our Service, we may require you to provide us with certain personally identifiable information, including but not limited to Name, Email, Contact Number, Date of Birth and Gender.</p>
               <p>The information that we request will be retained by us and used as described in this Privacy Policy.</p>
               <p>For deletion of data, you can simply contact us at info@luzo.app</p>
               ...
               <p>This policy is effective as of 25th August, 2022</p>
               <p>Contact Us</p>
               <p>If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us at info@luzo.app</p>
           </div>
